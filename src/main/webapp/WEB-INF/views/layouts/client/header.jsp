				...
				<div class="collapse navbar-collapse justify-content-between"
					...
					<div class="navbar-nav mr-auto">
						<a href="index.html" class="nav-item nav-link">Home</a> <a
							href="product-list.html" class="nav-item nav-link active">Products</a>
						<a href="product-detail.html" class="nav-item nav-link">Product
							...
							href="my-account.html" class="nav-item nav-link">My Account</a>
				...
				<div class="col-md-3">
					<div class="logo">
						<a href="index.html"> <img
							src=" <c:url value="/assets/client/img/logo.png" />" alt="Logo">
						</a>
					</div>
				</div>
				<div class="col-md-6">
